            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '\$ ${product.price * CartCubit.get(context).productsCount[index]}',
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (CartCubit.get(context).productsCount[index] > 1) {
                    ...
                    Text(
                      '${CartCubit.get(context).productsCount[index]}',
                      style: AppStyles.style18,
                    ),
                    Container(
                      width: screenSize.width * .1,
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(color: AppConstance.primaryColor),
                      ),
                      child: InkWell(
                        onTap: () {
